...
export class StatusbarPart extends Part implements IStatusbarEntryContainer {
...
export class StatusbarService extends MultiWindowParts<StatusbarPart> implements IStatusbarService {
	...
	readonly mainPart: StatusbarPart;
	...
	constructor(
		...
		this.mainPart = this._register(this.instantiationService.createInstance(StatusbarPart, Parts.STATUSBAR_PART));
