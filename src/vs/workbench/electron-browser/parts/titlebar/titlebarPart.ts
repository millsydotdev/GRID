...
export class NativeTitleService extends BrowserTitleService {
	...
	protected override createMainTitlebarPart(): NativeTitlebarPart {
		return this.instantiationService.createInstance(NativeTitlebarPart, Parts.TITLEBAR_PART, mainWindow, this.editorGroupsService.mainPart);
	}
