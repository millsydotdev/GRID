...
import { GRID_OPEN_SETTINGS_ACTION_ID } from '../../grid/browser/gridSettingsPane.js';
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		...
		title: nls.localize({ key: 'openVoid', comment: ['&& denotes a mnemonic'] }, "&&Open GRID Settings"),
	},
	order: 1
});
