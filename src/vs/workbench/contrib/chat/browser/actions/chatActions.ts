...
// DISABLED FOR GRID: We do not want the VS Code chat button in the titlebar/command center
...
// DISABLED FOR GRID: We do not want the VS Code chat button in the titlebar
