...
// gets converted to --vscode-grid-greenBG, see grid.css, asCssVariable
registerColor('grid.greenBG', configOfBG(acceptBG), '', true);
registerColor('grid.redBG', configOfBG(rejectBG), '', true);
registerColor('grid.sweepBG', configOfBG(sweepBG), '', true);
registerColor('grid.highlightBG', configOfBG(highlightBG), '', true);
registerColor('grid.sweepIdxBG', configOfBG(sweepIdxBG), '', true);
