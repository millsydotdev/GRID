...
export type DiffZone = {
	...
	_streamState:
		| {
				...
				line: number;
				cachedBlocks?: import('../../../common/helpers/extractCodeFromResult').ExtractedSearchReplaceBlock[]; // Cached S/R blocks for resuming
		...
		| {
				...
				lastProcessedBlockNum?: undefined;
		  };
	editorId?: undefined;
