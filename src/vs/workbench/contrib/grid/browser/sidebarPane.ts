...
// ---------- Register viewpane inside the grid container ----------

// const gridThemeIcon = Codicon.symbolObject;
// const gridViewIcon = registerIcon('grid-view-icon', gridThemeIcon, localize('gridViewIcon', 'View icon of the Grid chat view.'));

// called VIEWLET_ID in other places for some reason
export const GRID_VIEW_CONTAINER_ID = 'workbench.view.grid';
export const GRID_VIEW_ID = GRID_VIEW_CONTAINER_ID;
...
const container = viewContainerRegistry.registerViewContainer(
	{
		...
		title: nls.localize2('gridContainer', 'Chat'), // Chat container (Ctrl + L)
		...
		icon: FileAccess.asBrowserUri('vs/workbench/browser/media/code-icon.svg'), // GRID logo
	},
	...
	[
		{
			...
			name: nls.localize2('gridChat', ''), // this says ... : CHAT
...
// open sidebar
export const GRID_OPEN_SIDEBAR_ACTION_ID = 'grid.openSidebar';
registerAction2(
	class extends Action2 {
		constructor() {
			super({
				id: GRID_OPEN_SIDEBAR_ACTION_ID,
				title: 'Open GRID Sidebar',
			});
		}
...
export class SidebarStartContribution implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.startupGridSidebar';
	constructor(@ICommandService private readonly commandService: ICommandService) {
		this.commandService.executeCommand(GRID_OPEN_SIDEBAR_ACTION_ID);
	}
}
