...
import { Diff, DiffArea, GridFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	// testDiffs(): void;
	getGridFileSnapshot(uri: URI): GridFileSnapshot;
	restoreGridFileSnapshot(uri: URI, snapshot: GridFileSnapshot): void;
}
