...
import {
	GRID_ACCEPT_DIFF_ACTION_ID,
	GRID_REJECT_DIFF_ACTION_ID,
	GRID_GOTO_NEXT_DIFF_ACTION_ID,
	GRID_GOTO_PREV_DIFF_ACTION_ID,
	GRID_GOTO_NEXT_URI_ACTION_ID,
	GRID_GOTO_PREV_URI_ACTION_ID,
	GRID_ACCEPT_FILE_ACTION_ID,
	GRID_REJECT_FILE_ACTION_ID,
	GRID_ACCEPT_ALL_DIFFS_ACTION_ID,
	GRID_REJECT_ALL_DIFFS_ACTION_ID,
} from './actionIDs.js';
...
type GridCommandBarModule = typeof import('./react/out/grid-editor-widgets-tsx/index.js');
let mountGridCommandBarPromise: Promise<GridCommandBarModule['mountGridCommandBar']> | undefined;
function getMountGridCommandBar() {
	if (!mountGridCommandBarPromise) {
		mountGridCommandBarPromise = import('./react/out/grid-editor-widgets-tsx/index.js').then(
			(m) => m.mountGridCommandBar
		);
	}
	return mountGridCommandBarPromise;
}

export interface IGridCommandBarService {
...
export const IGridCommandBarService = createDecorator<IGridCommandBarService>('GridCommandBarService');
...
export class GridCommandBarService extends Disposable implements IGridCommandBarService {
	_serviceBrand: undefined;

	static readonly ID: 'grid.GridCommandBarService';
	...
	async goToURIIdx(idx: number | null): Promise<void> {
		...
		const { model } = await this._gridModelService.getModelSafe(nextURI);
		if (!model) return;
...
class AcceptRejectAllFloatingWidget extends Widget implements IOverlayWidget {
	...
	constructor(
		...
		const mountGridCommandBarPromise = getMountGridCommandBar();

		// Execute async operation, then invoke with fresh accessor
		(async () => {
			const uri = editor.getModel()?.uri || null;
			const mountGridCommandBar = await mountGridCommandBarPromise;
...
registerAction2(
	class extends Action2 {
		constructor() {
			super({
				id: GRID_ACCEPT_DIFF_ACTION_ID,
				f1: true,
				title: localize2('gridAcceptDiffAction', 'GRID: Accept Diff'),
				keybinding: {
...
registerAction2(
	class extends Action2 {
		constructor() {
			super({
				id: GRID_REJECT_DIFF_ACTION_ID,
				f1: true,
				title: localize2('gridRejectDiffAction', 'GRID: Reject Diff'),
				keybinding: {
...
registerAction2(
	class extends Action2 {
		constructor() {
			super({
				id: GRID_GOTO_NEXT_DIFF_ACTION_ID,
				f1: true,
				title: localize2('gridGoToNextDiffAction', 'GRID: Go to Next Diff'),
				keybinding: {
...
registerAction2(
	class extends Action2 {
		constructor() {
			super({
				id: GRID_GOTO_PREV_DIFF_ACTION_ID,
				f1: true,
				title: localize2('gridGoToPrevDiffAction', 'GRID: Go to Previous Diff'),
				keybinding: {
...
registerAction2(
	class extends Action2 {
		constructor() {
			super({
				id: GRID_GOTO_NEXT_URI_ACTION_ID,
				f1: true,
				title: localize2('gridGoToNextUriAction', 'GRID: Go to Next File with Diffs'),
				keybinding: {
...
registerAction2(
	class extends Action2 {
		constructor() {
			super({
				id: GRID_GOTO_PREV_URI_ACTION_ID,
				f1: true,
				title: localize2('gridGoToPrevUriAction', 'GRID: Go to Previous File with Diffs'),
				keybinding: {
...
registerAction2(
	class extends Action2 {
		constructor() {
			super({
				id: GRID_ACCEPT_FILE_ACTION_ID,
				f1: true,
				title: localize2('gridAcceptFileAction', 'GRID: Accept All Diffs in Current File'),
				keybinding: {
...
registerAction2(
	class extends Action2 {
		constructor() {
			super({
				id: GRID_REJECT_FILE_ACTION_ID,
				f1: true,
				title: localize2('gridRejectFileAction', 'GRID: Reject All Diffs in Current File'),
				keybinding: {
...
registerAction2(
	class extends Action2 {
		constructor() {
			super({
				id: GRID_ACCEPT_ALL_DIFFS_ACTION_ID,
				f1: true,
				title: localize2('gridAcceptAllDiffsAction', 'GRID: Accept All Diffs in All Files'),
				keybinding: {
...
registerAction2(
	class extends Action2 {
		constructor() {
			super({
				id: GRID_REJECT_ALL_DIFFS_ACTION_ID,
				f1: true,
				title: localize2('gridRejectAllDiffsAction', 'GRID: Reject All Diffs in All Files'),
				keybinding: {
