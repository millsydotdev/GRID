...
// let name_ = ''
// let testsFailed = 0
// const assertEqual = (a: Record<string, unknown>, b: Record<string, unknown>) => {
// 	let keys = new Set([...Object.keys(a), ...Object.keys(b)])
// 	for (let k of keys) {
// 		if (a[k] !== b[k]) {
// 			console.error('GRID Test Error:', name_, '\n', `${k}=`, `${JSON.stringify(a[k])}, ${JSON.stringify(b[k])}`)
...
// if (testsFailed === 0) {
// 	console.log('✅ GRID - All tests passed')
// }
// else {
// 	console.log('❌ GRID - At least one test failed')
// }
