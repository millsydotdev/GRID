...
- Fetches releases from GRID-NETWORK-REPO/versions repository
...
5. Uploads binaries to GRID-NETWORK-REPO/binaries
6. Updates version metadata in GRID-NETWORK-REPO/versions
